 ...
 * =====================================================
 */
var config = { //第一位 1患者的，2医护端；第二位0测试服务器版，1生产服务器版；第三位大版本号;第四位小版本号;第五位SVN版本号
	"version_med": "1.0.3.0.4551",
	"version_staff": "2.0.3.0.4551",
	"version_all":"3.0.4551"
};
var plus_debug = false;
var is_test = false;
var is_h5 = true;
var $ = mui;
	...
	function(a, b, c) {
		...
		a.ajax = function(d, e) {
			...
			var m, n = f.accepts[h.toLowerCase()],
				...
				u = f.xhr(f);
			u = new plus.net.XMLHttpRequest();
			var v = u.setRequestHeader;
		...
		b.addEventListener("tap", function(b) {
			if (e) {
				...
				if (d.contains("mui-collapse") && !e.parentNode.classList.contains("mui-unfold")) {
					if (!e.parentNode.classList.contains("mui-collapse-own") && (H.test(b.target.tagName) || b.detail.gesture.preventDefault(), !d.contains(g))) {
